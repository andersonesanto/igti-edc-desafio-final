...
with DAG(
    ...
    ingestion = KubernetesPodOperator(
        ...
        arguments=["set -x ; curl https://web-597495568095.s3.us-east-2.amazonaws.com/microdados_educacao_superior_2019.zip -o mes2019.zip; ls -l ; unzip -j -d dados mes2019.zip -i '*.CSV' ; aws s3 cp dados s3://datalake-edc-m5-597495568095/rawdata/ --recursive"],
        name="ingestion",
        task_id="ingestion",
        ...
        in_cluster=True,
        get_logs=True,
        env_vars={'AWS_ACCESS_KEY_ID': '{{ var.aws_access_key_id }}', 'AWS_SECRET_ACCESS_KEY': '{{ var.aws_secret_access_key }}'}
    )
